...
import { deleteImgFromCloudinary, uploadManyBuffersToCloudinary, } from "../../utils/cloudinary.js";
...
export const createProducts = asyncHandler(async (req, res) => {
    ...
    const uploadImages = await uploadManyBuffersToCloudinary(files.map((file) => file.buffer));
