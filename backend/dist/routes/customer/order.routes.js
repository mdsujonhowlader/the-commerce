...
import { checkoutPoints, checkoutSessionForPoints, } from "../../controller/customer/checkoutWithPoints.controller.js";
import { getCustomerOrder, patchCustomerOrderReturn, } from "../../controller/customer/order.controller.js";
...
customerOrderRoute.patch("/orders/:orderId/return", requireAuth, patchCustomerOrderReturn);
//points
customerOrderRoute.get("checkout/points", requireAuth, checkoutPoints);
customerOrderRoute.post("checkout/pay-with-points", requireAuth, checkoutSessionForPoints);
