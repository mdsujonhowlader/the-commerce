...
type CustomerMobileNavberProps = {
  isSignedIn: boolean;
};
...
export default function MobileCustomerNavbar({
  isSignedIn,
}: CustomerMobileNavberProps) {
  const mobileAccountItem: NavItem[] = isSignedIn
    ? [
    ...
    <div className={mobileWrap}>
      ...
      <Sheet>
        ...
        <SheetContent side="left" className={sheetContent}>
          ...
          <DrawerSection title="Accounts" items={mobileAccountItem} />
        </SheetContent>
      </Sheet>
    </div>
  );
